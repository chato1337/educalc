  ...
  },
  {
    ...
    targets: [
      ...
      },
      {
        ...
        columnsDescription:
          'Modo plantillas (sin DOC_ESTUDIANTE). Columnas: DANE_COD, AREA_ACADEMICA o AREA_NOMBRE o NUCLEO, GRADO, LOGRO_POSITIVO, LOGRO_NEGATIVO; PERIODO_NUM opcional (1–4, omitir = genérica).',
      },
      {
